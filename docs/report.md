...
2. Шесть графика: абсолютное и относительное отклонение импульса, абсолютное и относительное отклонение энергии, величина деформации и её приближение в момент контакта.
...
### 4.3. Максимальная деформация в зависимости от относительной скорости

При столкновении двух шаров кинетическая энергия движущихся тел переходит в потенциальную энергию упругой деформации. В момент максимального сжатия (относительная скорость сближения обращается в ноль) весь запас кинетической энергии относительного движения переходит в энергию Герца:

$$
\frac{1}{2}\mu v^2 = \frac{2}{5}k\delta_{max}^{5/2}, \qquad \mu = \frac{m_1 m_2}{m_1+m_2},
$$

откуда

$$
\delta_{max} \propto v^{4/5}.
$$

Эксперимент:
Одинаковые шары ($m_1=m_2=5$ кг, $r_1=r_2=1$ м), скорость сближения менялась от 0.5 до 10 м/с

![Величина максимальной деформации от скорости](max_deformation.png)

Степенная аппроксимация даёт показатель степени $0.800$. Ожидаемое значение: $4/5 = 0.8$. Совпадение с точностью до третьего знака.

### 4.4. Проверка по всем восьми базовым сценариям
